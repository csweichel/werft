    ...
    - |
      ...
      `}
                        ...
                        <li id="structured-logging">
                            <img src={logCutting} className="highlight" alt="" />
                        ...
                        <li>
                            <img src={results} className="highlight" alt="" />
                        ...
                        <li>
                            <div className="highlight" style={{height:'200px', backgroundColor: 'rgb(253, 246, 227)'}}>
                                picture goes here
                            </div>
